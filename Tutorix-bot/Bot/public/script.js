(function () {
  ...
  function injectStyles() {
    ...
    style.id = "tb-style";
    style.textContent = ""
      + ".tb-popup{position:fixed;right:16px;bottom:16px;width:340px;max-width:calc(100vw - 20px);z-index:2147483000;border-radius:20px;overflow:hidden;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;background:rgba(80,80,80,.25);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,.18);box-shadow:0 8px 32px rgba(0,0,0,.12),inset 0 1px 0 rgba(255,255,255,.2);}"
      + ".tb-head{display:flex;align-items:center;justify-content:space-between;padding:10px 12px;color:#f8fafc;background:rgba(80,80,80,.18);border-bottom:1px solid rgba(255,255,255,.18);}"
      ...
      + ".tb-settings-toggle{border:1px solid rgba(255,255,255,.28);background:rgba(255,255,255,.12);color:#f8fafc;border-radius:8px;padding:6px 8px;cursor:pointer;}"
      + ".tb-body{padding:10px;background:transparent;}"
      + ".tb-status{border-radius:12px;padding:10px;font-size:13px;line-height:1.35;min-height:70px;border:1px solid rgba(255,255,255,.22);background:rgba(30,41,59,.35);white-space:pre-wrap;color:#f8fafc;}"
      + ".tb-actions{display:flex;gap:8px;margin-top:8px;}"
      + ".tb-btn{border:1px solid rgba(255,255,255,.28);background:rgba(255,255,255,.14);color:#f8fafc;border-radius:10px;padding:8px 10px;font-size:12px;font-weight:700;cursor:pointer;}"
      + ".tb-settings{display:none;margin-top:10px;border-top:1px solid rgba(255,255,255,.24);padding-top:10px;} .tb-settings.active{display:block;}"
      + ".tb-settings label{display:block;font-size:12px;margin-top:6px;}"
      + ".tb-settings select{width:100%;padding:8px;border-radius:8px;border:1px solid rgba(255,255,255,.28);background:rgba(255,255,255,.14);color:#f8fafc;margin-top:4px;}"
      + ".tb-settings select option{color:#0f172a;}"
